    ...
    <div class="container">
        ...
        <ul class="pagination-list">
            <li class="pagination-item pagination-item-prev">
                <a href="<?= htmlspecialchars(updatePageNumber($currentPage > 1 ? $currentPage - 1 : 1)) ?>">Prev</a>
            </li>

            <?php foreach ($pages as $page) : ?>
            <li class="pagination-item <?= intval($page) === intval($currentPage) ? 'pagination-item-active' : '' ?>">
