...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            <!-- Lots list -->
            <?php foreach ($ads as $adKey => $adValue): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$adValue['imgUrl']; ?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$adValue["category"]; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$adValue["name"]; ?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=$adValue["price"]; ?><b class="rub">р</b></span>
                        </div>
